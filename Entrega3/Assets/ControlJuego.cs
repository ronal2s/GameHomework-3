...
//				print ('\t' + filasMapa [i] [j].ToString());
				...
				objeto = Instantiate(SpritesPrefabs[filasMapa[i][j].ToString()], new Vector3(((j*Random.Range(8,10)))- 8.3f,(i * -1) - 4f),Quaternion.identity);
				objeto.transform.localScale = new Vector3 (Random.Range (2f, 4), 0.5024082f,1); 
            }
        }
    }
